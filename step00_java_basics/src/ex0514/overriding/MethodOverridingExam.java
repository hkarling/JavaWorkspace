...
/*
 * overrriding의 기본조건 리턴타입,메소드이름,인수 같아야한다 modifier는 같거나 커야한다.
 */
...
class SubClass extends SuperClass {
	...
	public void methodZero() { // 접근제어자를 넓은 범위로..
		System.out.println("SubClass객체의 methodZero()메소드가 호출되었습니다.");
		System.out.println("intNumber=" + intNumber + "\t" + "memberString=" + memberString);
	}

	protected void methodOwn() { // 접근권한, return type이 다르다
		System.out.println("SubClass객체의 methodOwn()메소드가 호출되었습니다.");
		System.out.println("intNumber=" + intNumber + "\t" + "memberString=" + memberString);
		// return intNumber;
	}

	int methodTwo(int a) { // modifier, return type missmatch
		intNumber = a;
	...
	protected String methodThree(int k, String str) { // 접근권한 missmatch
		intNumber = k;
		memberString = str;
		System.out.println("SubClass객체의 methodThree()메소드가 호출되었습니다.");
		System.out.println("intNumber=" + intNumber + "\t" + "memberString=" + memberString);
	...
	@Override
	public void methodFour() { // return type missmatch
