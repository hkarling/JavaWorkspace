...
public class MainView {
	...
	public static void main(String[] args) {
		...
		//3.글번호에 해당하는 자료실검색 존재하는 게시물 검색할 경우와 없는 게시물 검색 각각 test 결과 출력하기
		...
		//BoardController.deleteBoard("photo", 10);
		//BoardController.deleteBoard("photo", 20);
		//BoardController.deleteBoard("photo", 30);
		
		//BoardController.deleteBoard("archive", 10);
		//BoardController.deleteBoard("archive", 20);
