...
public interface BoardService {
	 ...
	 * @throws : 게시물이 한개도 존재 하지 않는다면 InexistentException 예외가 발생한다. AllMap =>
	 *           AMap,PMap
	 */
	 ...
	 * @throws : kind에 해당하는 게시물이 한개도 없을 때 InexistentException예외발생 kind = > AB, PB 둘중
	 *           하나
	 */
	 ...
	 * @throws 검색하는 게시물이 없으면 InexistentException 예외발생 kind 잘못이면 kind exception
	 */
	 ...
	 * @throws: 등록하기 전에 글번호 중복을 체크해서 중복이면 DuplicateException발생 등록을 실패하면
	 *               InexistentException 발생
	 */
	...
	/**
	 * 7. 게시물 수정하기 공통 : 제목, 작성자, 내용 photo : imgName archive : fileName, fileSize
	 * 
